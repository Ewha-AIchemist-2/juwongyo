...
print('DecisionTressClassifier 정확도: {0:.4f}'.format(accuracy_score(y_test, dt_pred)))
...
def exec_kfold(clf, folds=5):
    ...
    for iter_count, (train_index, test_index) in enumerate(kfold.split(X_titanic_df)):
        X_train, Xtest = X_titanic_df.values[train_index], X_titanic_df.values[test_index]
